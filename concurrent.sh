...
#echo "" | tee ./text/1.txt ./text/2.txt ./text/3.txt ./text/4.txt ./text/5.txt ./text/join.txt ./text/success.txt ./text/fail.txt
...
#for((i=0;i<5;i++))
#do
#    ./hello.sh |tee 1.txt &&do_work 1.txt
#done
